...
var routes = [
    ...
    { path: 'manage', component: manage_employee_component_1.ManageEmployeeComponent },
...
AppRoutingModule = __decorate([
    core_1.NgModule({
        ...
        providers: [common_1.Location, { provide: common_1.LocationStrategy, useClass: common_1.HashLocationStrategy }, employee_service_1.EmployeeService]
    })
], AppRoutingModule);
